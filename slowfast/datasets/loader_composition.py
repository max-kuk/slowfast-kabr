...
def multiple_samples_collate(batch, fold=False):
    ...
    # assert False
    inputs, labels, labels1, video_idx, time, extra_data = zip(*batch)
    ...
    inputs, labels, labels1, video_idx, time, extra_data = (
    ...
    if fold:
        return [inputs], labels, labels1, video_idx, time, extra_data
    else:
        return inputs, labels, labels1, video_idx, time, extra_data
