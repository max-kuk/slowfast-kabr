...
def construct_optimizer(model, cfg):
    ...
    optim_params = [
        {
            ...
            "lr": cfg.SOLVER.BASE_LR * cfg.SOLVER.BACKBONE_LR_RATIO,
        },
        {
    ...
    assert total_num == len(non_bn_parameters) + len(head_non_bn_parameters) + len(
        bn_parameters
    ) + len(head_bn_parameters) + len(zero_parameters) + len(
        head_zero_parameters
    ...
    logger.info(
        "HEAD: bn {}, non bn {}, zero {}, lr {}".format(
            len(head_bn_parameters),
            len(head_non_bn_parameters),
            len(head_zero_parameters),
            cfg.SOLVER.BASE_LR,
        )
    )
