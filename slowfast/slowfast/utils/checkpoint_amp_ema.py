...
def save_best_checkpoint(
    path_to_job, model, model_ema, optimizer, loss_scaler, epoch, cfg, ema=False
):
    """
    Save a checkpoint.
    Args:
...
def load_test_checkpoint(cfg, model, model_ema):
    ...
    if cfg.TEST.CHECKPOINT_FILE_PATH != "":
        ...
        load_checkpoint_ema(
            model_ema.module, cfg.TEST.CHECKPOINT_FILE_PATH, use_ema=True
        )
        ...
        load_checkpoint_ema(
            model_ema.module, cfg.TRAIN.CHECKPOINT_FILE_PATH, use_ema=True
        )
    else:
        logger.info(
